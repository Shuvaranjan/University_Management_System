...
public class AddTeacher extends JDialog implements ActionListener{
    ...
    //Label
    private JLabel heading_label, name_label, empID_label, address_label, email_label, hs_percentagelabel, course_label, father_namelabel, dob_label, ph_label,  board_percentagelabel,aadhar_nolabel, branch_label, name2, empID2, email2, board2, course2, father_name2, dob2, ph2, aAdhar2, hs2, branch2;
    //Textfield
    ...
    public AddTeacher() {
        ...
        setResizable(false);
        getContentPane().setBackground(new Color(168, 0, 0));
    ...
    private void addComponents() {
        ...
        // heading
        heading_label = new JLabel("New Faculty Details");
        heading_label.setBounds(320, 0, 500, 50);
        heading_label.setForeground(new Color(168, 0, 0));
        ...
        father_name2.setForeground(new Color(255,255,255));
        add(father_name2);


        // roll
        empID_label = new JLabel("Employee ID:");
        empID_label.setBounds(50, 170, 200, 30);
        empID_label.setFont(new Font("serif", Font.PLAIN, 25));
        empID_label.setForeground(Color.WHITE);
        add(empID_label);

        empID2 = new JLabel("4250" + first3);
        empID2.setBounds(255, 170, 250, 30);
        empID2.setFont(new Font("serif", Font.PLAIN, 25));
        empID2.setForeground(Color.WHITE);
        add(empID2);
        ...
        dob2.setForeground(new Color(255,255,255));
        add(dob2);
        ...
        ph2.setForeground(new Color(255,255,255));
        add(ph2);
        ...
        aAdhar2.setForeground(new Color(255,255,255));
        add(aAdhar2);
        ...
        hs2.setForeground(new Color(255,255,255));
        add(hs2);
        ...
        // course
        course_label = new JLabel("Qualification:");
        ...
        //branch
        branch_label = new JLabel("Department:");
        ...
        branch2.setForeground(new Color(255,255,255));
         add(branch2);
        ...
        email2.setForeground(new Color(255,255,255));
        add(email2);
        ...
        board2.setForeground(new Color(255,255,255));
        add(board2);
        ...
        course2.setForeground(new Color(255,255,255));
        add(course2);
    ...
    if (e.getSource() == submit) {
        ...
        try {
            ...
            if (name.equals("") && fname.equals("") && dob.equals("") && address.equals("") && ph.equals("") && email.equals("") && board.equals("") && hs.equals("") && aadhar.equals("") && course.equals("------------Select Option----------") && branch.equals("------------Select Option----------")) {
                ...
                cbCourse.addMouseListener(new MouseAdapter() {
                ...
                cbBranch.addMouseListener(new MouseAdapter() {
               ...
               dateChooserdob.addMouseListener(new MouseAdapter() {

                @Override
                public void mouseEntered(MouseEvent e) {
                    dateChooserdob.setBorder(BorderFactory.createLineBorder(null));
                    dob2.setText("");
                }
                ...
                String query = "INSERT INTO faculty VALUES('"+name+"', '"+fname+"','"+roll+"','"+dob+"', '"+address+"','"+ph+"','"+email+"', '"+board+"', '"+hs+"', '"+aadhar+"', '"+course+"', '"+branch+"')";

                Conn con = new Conn();
                con.s.executeUpdate(query);
                JOptionPane.showMessageDialog(null, "<html><body style=\'color:green;\'><b>Teacher Details submitted successfully</b></body></html>");
